...
- `Кто там?` — Port Knocking + SSH brute-force + cron exploitation  
  → [`writeup.md`](./Кто%20там?%20-%20writeup.md)
...
| `hydra` | SSH/FTP brute-force | https://github.com/vanhauser-thc/thc-hydra |
| `linpeas` | Auto-privilege esc. | https://github.com/peass-ng/PEASS-ng |
...
→ Используй, модифицируй, делай выводы — но обязательно укажи автора: r0ddg9.